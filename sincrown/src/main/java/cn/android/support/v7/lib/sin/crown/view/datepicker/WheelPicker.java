package cn.android.support.v7.lib.sin.crown.view.datepicker;
...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
     ...
     */
    public int mVisibleItemCount, mDrawnItemCount;
     ...
     * 滚轮选择器绘制中心坐标
     */
    public int mDrawnCenterX, mDrawnCenterY;
    ...
    public WheelPicker(Context context, AttributeSet attrs) {
        ...
        mSelectedItemTextColor = a.getColor
                (R.styleable.WheelPicker_wheel_selected_item_text_color, 0xFF444444);//选中字体颜色
        mItemTextColor = a.getColor(R.styleable.WheelPicker_wheel_item_text_color, 0xFF888888);//默认字体颜色
        ...
        isCyclic = a.getBoolean(R.styleable.WheelPicker_wheel_cyclic, false);//fixme  ==================默认设置滚轮数据不循环
        ...
        isCurved = a.getBoolean(R.styleable.WheelPicker_wheel_curved, false);//fixme  ==================默认不是滚轮效果，是一般的平滑效果
